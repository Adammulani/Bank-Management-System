...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(676, 393);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(242, 38);
			this->button2->TabIndex = 4;
			this->button2->Text = L"Delete Admin";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &AdminDetails::button2_Click);
			// 
			// button1
			// 
