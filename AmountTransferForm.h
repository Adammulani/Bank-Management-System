...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(316, 49);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(890, 40);
			this->label3->TabIndex = 66;
			this->label3->Text = L"Transfer Money From One Account To Another Account ";
			// 
			// panelInput
			// 
